...
public class ObservabilityConfig {
    ...
    public ObservationRegistry observationRegistry(ObservationRegistry registry) {
        registry.observationConfig()
                .observationHandler(new ProducerRecordObservationHandler());
        return registry;
    }

    @Bean
    ObservationRegistryCustomizer<ObservationRegistry> addProducerRecordObservationHandler() {
        return (registry) -> registry.observationConfig().observationHandler(new ProducerRecordObservationHandler());
    }
