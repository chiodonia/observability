...
public class ObservabilityConfig {
    ...
    @Bean
    ObservationRegistryCustomizer<ObservationRegistry> addFixedKeyRecordObservationHandler() {
        return (registry) ->
                registry.observationConfig().observationHandler(new FixedKeyRecordObservationHandler());
    }

    @Bean
    ObservationRegistryCustomizer<ObservationRegistry> addProducerRecordObservationHandler() {
        return (registry) ->
                registry.observationConfig().observationHandler(new ProducerRecordObservationHandler());
    }
}
