...
public class ObservabilityConfig {
    ...
    //    @Bean
    public ObservationRegistry _observationRegistry(MeterRegistry meterRegistry, Tracer tracer) {
    ...
    //    @Bean
    public ObservationRegistry observationRegistry(ObservationRegistry registry) {
        registry.observationConfig()
                .observationHandler(new ConsumerRecordObservationHandler());
        return registry;
    }

    @Bean
    ObservationRegistryCustomizer<ObservationRegistry> addConsumerRecordObservationHandler() {
        return (registry) -> registry.observationConfig().observationHandler(new ConsumerRecordObservationHandler());
    }
